...
def schema_model_summary(version: str | float | int | None = "compat") -> dict[str, Any]:
    ...
    return {
        ...
        "v0_5_graph_validation_surface": {
            ...
            "vocabulary": "Node kinds are the core set plus the active profile's graph.node_kinds; profile relationship_constraints extend relation pairs (ADR-0046).",
            "cycles": "Warns when the folded edge set forms a cycle.",
