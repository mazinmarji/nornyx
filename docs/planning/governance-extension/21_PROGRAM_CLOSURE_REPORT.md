...
| Governed-package change reconciliation | Separate local model | `implemented` | `nornyx/governed_package.py`, shared change validator | governed-package and compatibility corpus tests | doc 07, scanner appendix, report 19 | Security tightening can reject malformed legacy input | Shared schema changes require package compatibility and golden review |
