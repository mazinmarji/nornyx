# GOAL-012: Stable control-plane release
...
Release readiness for Nornyx as a stable generalized agentic contract language,
with human approval required before any public release, tag, package change, or
