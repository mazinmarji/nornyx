...
Chapter 14 established that the inventory of uncovered surfaces is part of the interface. Listing 23.5 quotes the <span class="ix" data-ix="coverage inventory!CrewAI adapter">CrewAI adapter's inventory</span> from the module constant that ships beside the wrapper **[implemented]**:
